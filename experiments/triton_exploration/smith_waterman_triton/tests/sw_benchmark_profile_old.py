...
def main():
    reference_path = "/root/shuochen/Cornell_intern/triton_experiment/AGAThA/dataset/ref_profile.fasta"
    query_path = "/root/shuochen/Cornell_intern/triton_experiment/AGAThA/dataset/query_profile.fasta"
    ...
    # change this line
    results_path = output_dir / f"multi_grid_profile_results_{timestamp}.json"
    ...
    # change this line
    summary_path = output_dir / f"multi_grid_profile_summary_{timestamp}.json"
