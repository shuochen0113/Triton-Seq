...
def run_experiment(seq1, seq2):
    ...
    gpu_start = time.time()
    gssl = gpu_sw_single_block.smith_waterman_gpu_single_block(seq1, seq2)
    # gpu_score, gpu_pos, gpu_dp = gpu_sw_multi_grid.smith_waterman_gpu_multi_grid(seq1, seq2)
...
def main():
    reference_path = "/home/dylan-chen/shuochen/Cornell_intern/triton_experiment/AGAThA/dataset/ref_profile.fasta"
    query_path = "/home/dylan-chen/shuochen/Cornell_intern/triton_experiment/AGAThA/dataset/query_profile.fasta"
    ...
    # change this line
    results_path = output_dir / f"no_return_test_profile_results_{timestamp}.json"
    ...
    # change this line
    summary_path = output_dir / f"no_return_test_profile_summary_{timestamp}.json"
