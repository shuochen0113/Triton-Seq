...
from host.buffer_manager_OPv5 import create_pipeline_resources
...
PTX_PATH = project_root / "ptx_modification_0804" / "ptx" / "sw_kernel_OPv5_hack_HEF.ptx"
TRITON_PTX_PATH = project_root / "ptx_modification_0804" / "ptx" / "sw_kernel_OPv5.ptx"
