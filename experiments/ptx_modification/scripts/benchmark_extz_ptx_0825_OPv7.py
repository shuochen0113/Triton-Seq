# benchmarking/scripts/benchmark_extz_ptx_0822.py
"""
...
Usage:
    python benchmark_extz_ptx_0822.py
...
from utils.io_OPv7 import read_fasta_as_bytes
from utils.packing_kernel_OPv7 import pack_batch_into_buffers
from host.buffer_manager_OPv7 import create_pipeline_resources
from configs.task_config import AlignmentTask, SolutionConfiguration, create_affine_scoring, create_banded_z_drop_pruning
from framework_api_OPv7 import run_alignment_task
...
PTX_PATH = project_root / "ptx_modification_0804" / "ptx" / "sw_kernel_OPv7_t2_hack.ptx"
TRITON_PTX_PATH = project_root / "ptx_modification_0804" / "ptx" / "sw_kernel_OPv7_t2.ptx"
...
def run_ptx_alignment(q_list, r_list, *, ptx_path=PTX_PATH, use_shared: bool = True,
    ...
    shared_bytes_formula = ((header_bytes + 4 * STRIDE * 4 + 15) // 16) * 16
