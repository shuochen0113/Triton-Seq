...
from framework_api_OPv6_2 import run_alignment_task
...
# #============================================
    ...
    # --- MODIFIED: Reflect removal of dp_init in setup time description ---
    print(f"  - Setup Time (H2D, Pack)       : {total_setup_ms:.3f} ms") # Removed 'Init'
    # --- END MODIFICATION ---
